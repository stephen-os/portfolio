...
<Roadmap
  shipped={[
    "Flashcards with syntax highlighting for 50+ languages",
    "Quizzes with explanations and an answer history",
    "Local-first desktop app on Tauri, for Windows, macOS, and Linux",
    "Import and export as plain files: JSON decks, markdown notes",
    "Bring-your-own-AI content, no model baked in",
    "Goals and progress tracking",
  ]}
  inProgress={[
    "Notes: markdown that lives alongside the cards it came from",
  ]}
  planned={[
    "Study anywhere, with Git-style sync and you deciding which cards win a conflict",
    "Images on cards: kanji, diagrams, road signs",
    "Adaptive learning that surfaces your weak spots more often",
  ]}
/>
